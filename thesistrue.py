    ...
    for train_index, test_index in tscv.split(X):
        ...
        if len(train_index)==25:
            ...
            for j in range(95):
                   ...
                   A1, R1, _, _, _ = nonneg_rescal(faketraintnsr, 20, lambda_A=0.01, lambda_R=0.01)
                   print('end of 1st Rescal')
                   A2, R2, _, _, _ = nonneg_rescal(realtraintnsr, 20, lambda_A=0.01, lambda_R=0.01) # real only
                   print('end of 2nd Rescal')
                   A3, R3, _, _, _ = nonneg_rescal(faketesttnsr, 20, lambda_A=0.01, lambda_R=0.01) # fake-fake
                   print('end of 3rd Rescal')
                   A4, R4, _, _, _ = nonneg_rescal(realtesttnsr, 20, lambda_A=0.01, lambda_R=0.01) # real-fake
